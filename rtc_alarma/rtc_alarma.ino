...
// ALARMA 64
int seconds_alarm64 = 40; // Segundos alarma
int minutes_alarm64 = 17; // Minutos alarma
int hour_alarm64 = 20; // Horas alarma. Formato 24h
int day_alarm64 = 9; // Dia alarma
int month_alarm64 = 7; // Mes alarma
int year_alarm64 = 2014; // A̱o alarma
int weekday_alarm64 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 65
int seconds_alarm65 = 40; // Segundos alarma
int minutes_alarm65 = 17; // Minutos alarma
int hour_alarm65 = 20; // Horas alarma. Formato 24h
int weekday_alarm65 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 66
int seconds_alarm66 = 40; // Segundos alarma
int minutes_alarm66 = 17; // Minutos alarma
int hour_alarm66 = 20; // Horas alarma. Formato 24h
int weekday_alarm66 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 67
int seconds_alarm67 = 40; // Segundos alarma
int minutes_alarm67 = 17; // Minutos alarma
int hour_alarm67 = 20; // Horas alarma. Formato 24h
int weekday_alarm67 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 68
int seconds_alarm68 = 40; // Segundos alarma
int minutes_alarm68 = 17; // Minutos alarma
int hour_alarm68 = 20; // Horas alarma. Formato 24h
int weekday_alarm68 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 69
int seconds_alarm69 = 40; // Segundos alarma
int minutes_alarm69 = 17; // Minutos alarma
int hour_alarm69 = 20; // Horas alarma. Formato 24h
int weekday_alarm69 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 70
int seconds_alarm70 = 40; // Segundos alarma
int minutes_alarm70 = 17; // Minutos alarma
int hour_alarm70 = 20; // Horas alarma. Formato 24h
int weekday_alarm70 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 71
int seconds_alarm71 = 40; // Segundos alarma
int minutes_alarm71 = 17; // Minutos alarma
int hour_alarm71 = 20; // Horas alarma. Formato 24h
int weekday_alarm71 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 72
int seconds_alarm72 = 40; // Segundos alarma
int minutes_alarm72 = 17; // Minutos alarma
int hour_alarm72 = 20; // Horas alarma. Formato 24h
int weekday_alarm72 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 73
int seconds_alarm73 = 40; // Segundos alarma
int minutes_alarm73 = 17; // Minutos alarma
int hour_alarm73 = 20; // Horas alarma. Formato 24h
int weekday_alarm73 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 74
int seconds_alarm74 = 40; // Segundos alarma
int minutes_alarm74 = 17; // Minutos alarma
int hour_alarm74 = 20; // Horas alarma. Formato 24h
int weekday_alarm74 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 75
int seconds_alarm75 = 40; // Segundos alarma
int minutes_alarm75 = 17; // Minutos alarma
int hour_alarm75 = 20; // Horas alarma. Formato 24h
int weekday_alarm75 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 76
int seconds_alarm76 = 40; // Segundos alarma
int minutes_alarm76 = 17; // Minutos alarma
int hour_alarm76 = 20; // Horas alarma. Formato 24h
int weekday_alarm76 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 77
int seconds_alarm77 = 40; // Segundos alarma
int minutes_alarm77 = 17; // Minutos alarma
int hour_alarm77 = 20; // Horas alarma. Formato 24h
int weekday_alarm77 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 78
int seconds_alarm78 = 40; // Segundos alarma
int minutes_alarm78 = 17; // Minutos alarma
int hour_alarm78 = 20; // Horas alarma. Formato 24h
int weekday_alarm78 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 79
int seconds_alarm79 = 40; // Segundos alarma
int minutes_alarm79 = 17; // Minutos alarma
int hour_alarm79 = 20; // Horas alarma. Formato 24h
int weekday_alarm79 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 80
int seconds_alarm80 = 40; // Segundos alarma
int minutes_alarm80 = 17; // Minutos alarma
int hour_alarm80 = 20; // Horas alarma. Formato 24h
int weekday_alarm80 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 81
int seconds_alarm81 = 40; // Segundos alarma
int minutes_alarm81 = 17; // Minutos alarma
int hour_alarm81 = 20; // Horas alarma. Formato 24h
int weekday_alarm81 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 82
int seconds_alarm82 = 40; // Segundos alarma
int minutes_alarm82 = 17; // Minutos alarma
int hour_alarm82 = 20; // Horas alarma. Formato 24h
int weekday_alarm82 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 83
int seconds_alarm83 = 40; // Segundos alarma
int minutes_alarm83 = 17; // Minutos alarma
int hour_alarm83 = 20; // Horas alarma. Formato 24h
int weekday_alarm83 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 84
int seconds_alarm84 = 40; // Segundos alarma
int minutes_alarm84 = 17; // Minutos alarma
int hour_alarm84 = 20; // Horas alarma. Formato 24h
int weekday_alarm84 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 85
int seconds_alarm85 = 40; // Segundos alarma
int minutes_alarm85 = 17; // Minutos alarma
int hour_alarm85 = 20; // Horas alarma. Formato 24h
int weekday_alarm85 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 86
int seconds_alarm86 = 40; // Segundos alarma
int minutes_alarm86 = 17; // Minutos alarma
int hour_alarm86 = 20; // Horas alarma. Formato 24h
int weekday_alarm86 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 87
int seconds_alarm87 = 40; // Segundos alarma
int minutes_alarm87 = 17; // Minutos alarma
int hour_alarm87 = 20; // Horas alarma. Formato 24h
int weekday_alarm87 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 88
int seconds_alarm88 = 40; // Segundos alarma
int minutes_alarm88 = 17; // Minutos alarma
int hour_alarm88 = 20; // Horas alarma. Formato 24h
int weekday_alarm88 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 89
int seconds_alarm89 = 40; // Segundos alarma
int minutes_alarm89 = 17; // Minutos alarma
int hour_alarm89 = 20; // Horas alarma. Formato 24h
int weekday_alarm89 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 90
int seconds_alarm90 = 40; // Segundos alarma
int minutes_alarm90 = 17; // Minutos alarma
int hour_alarm90 = 20; // Horas alarma. Formato 24h
int weekday_alarm90 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 91
int seconds_alarm91 = 40; // Segundos alarma
int minutes_alarm91 = 17; // Minutos alarma
int hour_alarm91 = 20; // Horas alarma. Formato 24h
int weekday_alarm91 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 92
int seconds_alarm92 = 40; // Segundos alarma
int minutes_alarm92 = 17; // Minutos alarma
int hour_alarm92 = 20; // Horas alarma. Formato 24h
int weekday_alarm92 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 93
int seconds_alarm93 = 40; // Segundos alarma
int minutes_alarm93 = 17; // Minutos alarma
int hour_alarm93 = 20; // Horas alarma. Formato 24h
int weekday_alarm93 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 94
int seconds_alarm94 = 40; // Segundos alarma
int minutes_alarm94 = 17; // Minutos alarma
int hour_alarm94 = 20; // Horas alarma. Formato 24h
int weekday_alarm94 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 95
int seconds_alarm95 = 40; // Segundos alarma
int minutes_alarm95 = 17; // Minutos alarma
int hour_alarm95 = 20; // Horas alarma. Formato 24h
int weekday_alarm95 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 96
int seconds_alarm96 = 40; // Segundos alarma
int minutes_alarm96 = 17; // Minutos alarma
int hour_alarm96 = 20; // Horas alarma. Formato 24h
int weekday_alarm96 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 97
int seconds_alarm97 = 40; // Segundos alarma
int minutes_alarm97 = 17; // Minutos alarma
int hour_alarm97 = 20; // Horas alarma. Formato 24h
int weekday_alarm97 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 98
int seconds_alarm98 = 40; // Segundos alarma
int minutes_alarm98 = 17; // Minutos alarma
int hour_alarm98 = 20; // Horas alarma. Formato 24h
int weekday_alarm98 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 99
int seconds_alarm99 = 40; // Segundos alarma
int minutes_alarm99 = 17; // Minutos alarma
int hour_alarm99 = 20; // Horas alarma. Formato 24h
int weekday_alarm99 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 100
int seconds_alarm100 = 40; // Segundos alarma
int minutes_alarm100 = 17; // Minutos alarma
int hour_alarm100 = 20; // Horas alarma. Formato 24h
int weekday_alarm100 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 101
int seconds_alarm101 = 40; // Segundos alarma
int minutes_alarm101 = 17; // Minutos alarma
int hour_alarm101 = 20; // Horas alarma. Formato 24h
int weekday_alarm101 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 102
int seconds_alarm102 = 40; // Segundos alarma
int minutes_alarm102 = 17; // Minutos alarma
int hour_alarm102 = 20; // Horas alarma. Formato 24h
int weekday_alarm102 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 103
int seconds_alarm103 = 40; // Segundos alarma
int minutes_alarm103 = 17; // Minutos alarma
int hour_alarm103 = 20; // Horas alarma. Formato 24h
int weekday_alarm103 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 104
int seconds_alarm104 = 40; // Segundos alarma
int minutes_alarm104 = 17; // Minutos alarma
int hour_alarm104 = 20; // Horas alarma. Formato 24h
int weekday_alarm104 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

// ALARMA 105
int seconds_alarm105 = 40; // Segundos alarma
int minutes_alarm105 = 17; // Minutos alarma
int hour_alarm105 = 20; // Horas alarma. Formato 24h
int weekday_alarm105 = 1; // Dia de la semana alarma. L(1), M(2), MX(3), J(4), V(5), S(6), D(7)

boolean all_seconds

= false; // Alarma para todos los segundos
...
const int botonCancelPin = 4;
const int botonEnterPin = 3;
int menu = 0;
...
attachInterrupt(0, changeMenu, RISING);
//attachInterrupt(1, cambiarValor, RISING);
// activate LCD module
...
cancelStatus = digitalRead(botonCancelPin);
if(cancelStatus == HIGH){
  menu = 0;
  cambio = 1;
}
